...
const state = {
    ...
    harmonise() {
        try {
            ...
            consoleElement.innerText = `${error} (Bar ${time.bar + 1}, chord ${time.event + 1})`;
        }
    },
    prependBar() {
            ...
            if (!e.ctrlKey && !e.shiftKey) {
                switch (e.key) {
                    ...
                    case "1":
                        ...
                        break;
                    case "2":
                        this.defaultNote().getPitch().setOctave(2);
                        break;
                    case "3":
                        this.defaultNote().getPitch().setOctave(3);
                        break;
                    case "4":
                        this.defaultNote().getPitch().setOctave(4);
                        break;
                    case "5":
                        this.defaultNote().getPitch().setOctave(5);
                        break;
                    case "#":
                        this.defaultNote().getPitch().getTone().alterAccidental(1);
                        break;
                    case "'":
                        this.defaultNote().getPitch().getTone().alterAccidental(-1);
                        break;
                    case ",":
                        switch (this.defaultNote().getDuration()) {
                            case 0.25:
                                this.defaultNote().setDuration(0.5);
                                break;
                            case 0.5:
                                this.defaultNote().setDuration(1);
                                break;
                            case 0.75:
                                this.defaultNote().setDuration(1.5);
                                break;
                            case 1:
                                this.defaultNote().setDuration(2);
                                break;
                            case 1.5:
                                this.defaultNote().setDuration(3);
                                break;
                            case 2:
                                this.defaultNote().setDuration(4);
                                break;
                            case 3:
                                this.defaultNote().setDuration(6);
                                break;
                        }
                        break;
                    case ".":
                        switch (this.defaultNote().getDuration()) {
                            case 0.5:
                                this.defaultNote().setDuration(0.75);
                                break;
                            case 0.75:
                                this.defaultNote().setDuration(0.5);
                                break;
                    ...
                    case "/":
                        switch (this.defaultNote().getDuration()) {
                            case 0.5:
                                this.defaultNote().setDuration(0.25);
                                break;
                            case 1:
                                this.defaultNote().setDuration(0.5);
                                break;
